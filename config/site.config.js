...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'holts@hnyuyin.com',
  ...
  email: 'mailto:holts@hnyuyin.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/holts/onedrive-vercel-index',
    },
    {
      name: 'Telegram',
